class sshd::params {
  ...
  $sshd_config_key_regeneration_interval = hiera('sshd_config_key_regeneration_interval','3600')
  ...
  $sshd_config_kbd_interactive_auth      = hiera('sshd::sshd_config_kbd_interactive_auth', 'no')
